...
class UtfNormalUtil
{
	 ...
	 * @private
	 */
	static function hexSequenceToUtf8( $sequence ) {
		$utf = '';
	 ...
	 * @private
	 */
	static function utf8ToHexSequence( $str ) {
		$buf = '';
	 ...
	 * @public
	 */
	static function utf8ToCodepoint( $char ) {
		# Find the length
		$z = ord( $char[0] );
		if ( $z & 0x80 ) {
			$length = 0;
	 ...
	 * @public
	 */
	static function escapeSingleString( $string ) {
		return strtr( $string,
			array(
				'\\' => '\\\\',
				'\'' => '\\\''
