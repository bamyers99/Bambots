...
class ReportGenerator
{
	...
	function writeAlphaFooter($alphahndl, $page_number, $filesafe_project)
	{
	    ...
	    fwrite($alphahndl, "<div>Generated by <a href='https://en.wikipedia.org/wiki/User:CleanupWorklistBot' class='novisited'>CleanupWorklistBot</a></div></body></html>");
	}
	...
	function writeBycatFooter($bycathndl, $page_number, $filesafe_project)
	{
	    ...
	    fwrite($bycathndl, "<div>Generated by <a href='https://en.wikipedia.org/wiki/User:CleanupWorklistBot' class='novisited'>CleanupWorklistBot</a></div></body></html>");
	}
}